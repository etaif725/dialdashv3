...
export class EmailService {
  ...
  async sendFollowUpEmail(lead: { 
    ...
    const bookingLink = import.meta.env.VITE_CALCOM_BOOKING_LINK || 'https://cal.com/dialwise/consultation';
    ...
    const fromEmail = import.meta.env.RESEND_FROM_EMAIL || 'info@dialwise.ai';
    const fromName = import.meta.env.RESEND_FROM_NAME || 'DialWise AI Team';
